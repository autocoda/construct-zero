                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        <RouterLink to="/" class="flex-shrink-0 flex items-center">
                            <img class="block lg:hidden h-8 w-auto" src="https://projectpay.com.au/wp-content/uploads/2020/07/ProjectPay_Logo.png" alt="Workflow" />
                            <img class="hidden lg:block h-8 w-auto" src="https://projectpay.com.au/wp-content/uploads/2020/07/ProjectPay_Logo.png" alt="Workflow" />
                        </RouterLink>
