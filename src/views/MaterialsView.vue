...
<template>
    <PageHeader title="Enter your Materials"></PageHeader>
    <MainWrapper>
        <div class="lg:grid lg:grid-cols-12 lg:gap-x-5">
            <SideNav active="materials"></SideNav>
                ...
                <form action="#" method="POST">
                    <div class="shadow sm:rounded-md sm:overflow-hidden">
                        <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                            <div>
                                <h3 class="text-lg leading-6 font-medium text-gray-900">Form Information</h3>
                                <p class="mt-1 text-sm text-gray-500">This form will be for materials.</p>
                            </div>
        ...
        <NextButton to="/equipment">Next</NextButton>
    </MainWrapper>
</template>
