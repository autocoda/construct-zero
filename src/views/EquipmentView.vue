...
<template>
    <PageHeader title="Enter your Equipment"></PageHeader>
    <MainWrapper>

        <div class="lg:grid lg:grid-cols-12 lg:gap-x-5">
            <SideNav active="equipment"></SideNav>
                    ...
                    <div class="shadow sm:rounded-md sm:overflow-hidden">
                        <div class="bg-white py-6 px-4 space-y-6 sm:p-6">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-500">This form will be for equipment.</p>
                            </div>
        ...
        <NextButton to="/personnel">Next</NextButton>
    </MainWrapper>
</template>
